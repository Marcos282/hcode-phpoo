<?php if(!class_exists('Rain\Tpl')){exit;}?> <div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/PROJETO/resorces/site/js/owl.carousel.min.js"></script>
    <script src="/PROJETO/resorces/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/PROJETO/resorces/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/PROJETO/resorces/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/PROJETO/resorces/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/PROJETO/resorces/site/js/script.slider.js"></script>
  </body>
</html>