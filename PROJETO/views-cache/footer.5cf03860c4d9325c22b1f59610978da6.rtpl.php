<?php if(!class_exists('Rain\Tpl')){exit;}?> <div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/resorces/site/js/owl.carousel.min.js"></script>
    <script src="/resorces/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/resorces/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/resorces/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/resorces/js/bxslider.min.js"></script>
    <script type="text/javascript" src="/resorces/site/js/script.slider.js"></script>
  </body>
</html>