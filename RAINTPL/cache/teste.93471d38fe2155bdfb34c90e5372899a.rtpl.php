...
<body>
    ...
    The title is: <?php echo (htmlspecialchars( isset($title), ENT_COMPAT, 'UTF-8', FALSE )?htmlspecialchars( "$title", ENT_COMPAT, 'UTF-8', FALSE ):'default title'); ?>
	...
	{%message to translate|english%} <br><br>
        ...
        <?php echo htmlspecialchars( $bad_variable, ENT_COMPAT, 'UTF-8', FALSE ); ?>
